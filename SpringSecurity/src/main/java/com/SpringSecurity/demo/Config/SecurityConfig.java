...
import com.SpringSecurity.demo.Filters.JWTFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityChain(HttpSecurity httpSecurity) throws Exception{
        ...
        .authorizeHttpRequests(
            ...
            .permitAll() //open link
            . anyRequest().authenticated()    //closed resources
        ) //doing authentication
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        provider.setPasswordEncoder(new BCryptPasswordEncoder(12)); //Bcrypt password encoder
        provider.setUserDetailsService(userDetailsService);
        return provider;
    }

    //AuthenticationManager layer for spring security
    @Bean //bean means we are handling the step
